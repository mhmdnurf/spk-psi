...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="<?= base_url('Alternatif'); ?>" class="btn btn-danger btn-icon-split"><span class="icon text-white-50"><i class="fas fa-arrow-left"></i></span>
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="form-group col-md-12">
					...
					<input autocomplete="off" type="number" name="nisn" value="<?php echo $alternatif->nisn ?>" required class="form-control"/>
				</div>
				<div class="form-group col-md-12">
				...
				<div class="form-group col-md-12">
					...
					<input autocomplete="off" type="text" name="gelombang" value="<?php echo $alternatif->gelombang ?>" required class="form-control"/>
				</div>
			</div>
		</div>
